...
import { addSlotsDoctor, getSlotsByDayDoctor, getAllSlotsDoctor, deleteManyByDayDoctor, addSlotsAllDayDoctor, deleteSlotsAllDayDoctor, getSlotsOfDoctor } from "@/lib/api/slots/route";
