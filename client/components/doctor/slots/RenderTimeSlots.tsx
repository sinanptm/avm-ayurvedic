...
export const RenderTimeSlots = (
   ...
   <div className="mb-6 rounded-lg p-4 shadow-lg">
         ...
         {times.map((time, index) => (
            <Button
               ...
               className={cn(
                  ...
                  "hover:scale-105",
                  selectedSlots.includes(time) ? "bg-red-600  text-white" : "bg-gray-700 text-gray-200"
               )}
      ...
      <div className="flex justify-between items-center mt-4">
         <Button variant="destructive" onClick={onClearAll} className="text-xs sm:text-sm px-3 py-2">
            Clear All
         </Button>
         <Button
            variant="default"
