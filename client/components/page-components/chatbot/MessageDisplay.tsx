      ...
      () =>
         messages.map((msg, index) => {
            ...
            return (
               ...
               >
                  <div
                     className={`flex items-end space-x-2 sm:space-x-3 ${!msg.isBotMessage ? "flex-row-reverse space-x-reverse" : ""}`}
                  >
                     <div
                        className={`w-6 h-6 sm:w-8 sm:h-8 flex rounded-full items-center justify-center ${!msg.isBotMessage ? "bg-green-600" : "bg-gray-600"}`}
                     >
                        <Image
                     ...
                     <div
                        className={`max-w-[80%] text-xs sm:text-sm p-2 sm:p-3 rounded-xl sm:rounded-2xl shadow-md ${msg.isBotMessage ? "bg-green-600" : "bg-gray-700"}`}
                     >
