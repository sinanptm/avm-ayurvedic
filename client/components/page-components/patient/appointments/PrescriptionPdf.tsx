  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.infoGrid}>
        ...
        <View style={styles.infoColumn}>
          <View style={styles.section}>
            ...
            <Text style={styles.text}>DOB: {patient.dob ? format(new Date(patient.dob), 'MMMM dd, yyyy') : 'N/A'}</Text>
      ...
      <View style={styles.section}>
        ...
        <Text style={[styles.text, styles.bold]}>Date: {prescription.createdAt ? format(new Date(prescription.createdAt), 'MMMM dd, yyyy') : 'N/A'}</Text>
      ...
      <View style={styles.footer}>
        <Text>This is a digital prescription from AVM Ayurvedic. Please contact your doctor at {doctor.phone} if you have any questions.</Text>
