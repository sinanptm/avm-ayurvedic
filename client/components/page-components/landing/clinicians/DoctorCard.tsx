         ...
         <div className="space-y-2 mb-4 text-sm text-muted-foreground">
            {doctor.phone && (
               <div className="flex items-center gap-2">
                  <Image src="/assets/icons/phone.svg" width={16} height={16} alt="Phone" className="mr-2 w-5 h-5" />
                  <span className="truncate">{doctor.phone}</span>
               </div>
            )}
            {doctor.email && (
               <div className="flex items-center gap-2">
                  <Image src="/assets/icons/email.svg" width={16} height={16} alt="Email" className="mr-2 w-5 h-5" />
