...
const values = [
   ...
   { title: "Personalized Care", description: "Every treatment plan is tailored to the individual." },
   {
      ...
      description: "We combine traditional Ayurveda with contemporary research.",
   },
      ...
      <Card className="mb-8">
         ...
         <CardContent>
            <p className="text-base mb-4 text-muted-foreground">
               Our mission is to empower individuals to achieve optimal health and harmony through the timeless wisdom
               of Ayurveda, delivered with compassion and expertise.
            </p>
