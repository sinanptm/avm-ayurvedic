...
const AdminLayoutWithSideBar = ({
   ...
   const renderSidebarLink = useCallback(
      (item: NavLinkType) => (
            ...
            <aside className="fixed inset-y-0 left-0 z-10 hidden w-14 flex-col border-r bg-background sm:flex">
               ...
               <div className="mt-auto flex flex-col items-center gap-4 px-2 py-5">
                  <Tooltip>
                     ...
                     <TooltipContent side="right" className="bg-green-700 bg-opacity-55 border-white cursor-pointer">
                        Video Sections
                     </TooltipContent>
                  </Tooltip>
                  <Tooltip>
                  ...
                  <DropdownMenu>
                     ...
                     <DropdownMenuContent align="end">
                        <DropdownMenuItem>
                           <button className="flex items-center w-full text-left" onClick={toggleLogoutModal}>
                              <Image
