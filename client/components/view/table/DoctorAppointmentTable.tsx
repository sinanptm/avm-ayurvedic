...
export default function AppointmentTable({ page }: Props) {
  ...
  const limit = 7;
  const { data, isLoading, error, refetch } = useGetAppointmentsDoctor(currentPage, limit, statusFilter === 'all' ? undefined : statusFilter);
      ...
      <CardHeader>
        <div className="flex justify-between items-center">
          <div>
            ...
            <CardDescription>
              A list of appointments including date, type, reason, and status.
            </CardDescription>
          </div>
          <Select value={statusFilter} onValueChange={(value) => handleStatusChange(value as AppointmentStatus | 'all')}>
