  ...
  <div className="w-full max-w-6xl mx-auto mb-20 px-4">
    ...
    <Accordion type="single" collapsible className="w-full">
      ...
      <AccordionItem value="item-2">
        <AccordionTrigger className="text-lg">How long does an Ayurvedic treatment typically last?</AccordionTrigger>
        <AccordionContent className="text-base">
          The duration of Ayurvedic treatments varies depending on the individual and the condition being treated. Some treatments may last a few weeks, while others might continue for several months. Your Ayurvedic practitioner will create a personalized treatment plan based on your specific needs and health goals.
        </AccordionContent>
      </AccordionItem>
      ...
      <AccordionItem value="item-4">
        <AccordionTrigger className="text-lg">What can I expect during my first Ayurvedic consultation?</AccordionTrigger>
        <AccordionContent className="text-base">
          During your first Ayurvedic consultation, the practitioner will conduct a thorough assessment of your physical, mental, and emotional health. This may include pulse diagnosis, tongue examination, and detailed questions about your lifestyle, diet, and health history. Based on this evaluation, they will determine your dosha (constitution) and create a personalized treatment plan that may include dietary recommendations, herbal remedies, lifestyle changes, and therapeutic treatments.
        </AccordionContent>
      </AccordionItem>
    </Accordion>
  </div>
