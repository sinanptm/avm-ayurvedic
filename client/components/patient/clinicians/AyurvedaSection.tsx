...
export const AyurvedaSection = () => (
  <div className="w-full max-w-6xl mx-auto bg-primary/5 rounded-lg p-8 md:p-12 my-20">
    ...
    <div className="space-y-6 text-base md:text-lg">
      ...
      <p>
        Our doctors are dedicated to providing personalized care by blending traditional Ayurvedic methods with modern medicine.
        This includes practices like detoxification (Panchakarma), herbal treatments, dietary recommendations, and lifestyle guidance
