               ...
               <CardContent className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="md:w-1/2">
                     ...
                     <p className="mb-4">
                        ...
                        technology, integrated with Ayurvedic principles. From MRI and CT scans to ultrasound and X-rays,
                        we offer accurate and timely results to support your holistic healthcare needs.
                     </p>
            ...
            <Card className="mt-8">
               ...
               <CardContent className="flex flex-col md:flex-row gap-6">
                  <div className="md:w-1/2 order-2 md:order-1">
                     ...
                     <p className="mb-4">
                        Connect with our Ayurvedic experts from the comfort of your home. Our video call services provide 
                        you with personalized consultations, follow-ups, and treatment plans tailored to your needs.
                     </p>
                     <Button variant={"outline"} className="cursor-pointer">
                        Book Now
                     </Button>
