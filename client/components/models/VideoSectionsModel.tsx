                  ...
                  <Card className="hover:bg-dark-100 transition-colors duration-200">
                    <CardContent className="flex items-center justify-between p-2 sm:p-4">
                      <div className="flex items-center space-x-2 sm:space-x-4">
                        ...
                        <div>
                          <h3 className="font-semibold text-sm sm:text-base">{user === 'patient' ? section.doctorName : section.patientName}</h3>
                          <p className="text-xs sm:text-sm text-muted-foreground">{format(section.startTime!, "hh:mm a")}</p>
                        </div>
                      </div>
                      <ButtonV2
                        variant="expandIcon"
