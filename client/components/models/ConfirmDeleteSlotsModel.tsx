         ...
         <AlertDialogContent className="sm:max-w-[425px] w-[95vw] p-6 bg-dark-200">
            ...
            <AlertDialogContent className="space-y-4 text-base">
               <AlertDialogHeader className="space-y-4">
                  ...
                  <div>
                     <p>You are about to delete selected time slot&apos;s. Please review the following implications:</p>
                  </div>
                  <div>
               ...
               <AlertDialogFooter className="sm:justify-start mt-6 space-x-4">
                  <AlertDialogCancel className="sm:w-1/2 w-full mb-2 sm:mb-0">Keep Slots</AlertDialogCancel>
                  <Button variant="destructive" onClick={handleDeleteSlots} className="sm:w-1/2 w-full">
                     Confirm Deletion
                  </Button>
               </AlertDialogFooter>
            </AlertDialogContent>
