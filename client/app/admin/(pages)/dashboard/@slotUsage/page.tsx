            ...
            <ResponsiveContainer width="100%" height="100%">
               <BarChart data={sortedData} margin={{ top: 10, right: 10, left: 0, bottom: 40 }}>
                  ...
                  <XAxis
                     ...
                     tick={{ fontSize: 10 }}
                  />
                  <YAxis width={40} tick={{ fontSize: 10 }} tickFormatter={(value) => value.toLocaleString()} />
                  <ChartTooltip
                     content={
                        <ChartTooltipContent
                  ...
                  />
                  <Bar dataKey="count" fill="var(--color-appointments)" name="Appointments" radius={[2, 2, 0, 0]} />
               </BarChart>
            </ResponsiveContainer>
         </ChartContainer>
      </>
