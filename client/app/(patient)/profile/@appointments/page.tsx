...
export default function AppointmentsPage() {
  ...
  const handleBookAppointment = (e: React.FormEvent) => {
    ...
    console.log('Booking appointment:', { newAppointmentDate, newAppointmentTime, newAppointmentDoctor, newAppointmentNotes })
    // Reset form fields
        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handleBookAppointment} className="space-y-4">
              ...
              <Button type="submit" className="w-full bg-green-600 hover:bg-green-700 text-white">Book Appointment</Button>
            </form>
          </CardContent>
        </Card>
      </div>
