        ...
        <Card className="overflow-hidden">
          ...
          <CardContent className="p-4 sm:p-6">
            <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
              ...
              <Button variant="outline" className="flex-1">Reviews</Button>
              <Button variant="outline" className="flex-1">Availability</Button>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4 sm:p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <p><span className="font-semibold text-green-400">Specializations:</span> Anxiety, Depression, Stress Management</p>
                <p><span className="font-semibold text-green-400">Languages:</span> English, Spanish</p>
              </div>
              <div>
                <p><span className="font-semibold text-green-400">Experience:</span> 15+ years</p>
                <p><span className="font-semibold text-green-400">Session Duration:</span> 50 minutes</p>
              </div>
            </div>
          </CardContent>
        </Card>
